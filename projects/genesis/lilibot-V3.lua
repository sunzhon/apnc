...
function initParametersSlide()
    ...
    controlParameters={ 0.0,0.04,0.04, 0.0,0.04,0.04, 0.0,-0.06,-0.06,  0.02,0.75,5}
...
function sysCall_init()
    ...
    if (not pluginNotFound) then
        ...
        -- Start rosnode
        result=sim.launchExecutable(simGetStringParameter(sim_stringparam_scene_path) .. '/../../../../utils/real_robots/stbot/catkin_ws/src/start_robot/start_lilibot_vrep',0)
...
function sysCall_sensing()
   ...
   -- sensor_array[i + #joint_array] = force[3]/10.0    
    sensor_array[i + #joint_array] = ((force[3]>0.0)  and force[3]/20.0 or 0.0) --+ ((force[3]/10.0 > 0.1) and 0.5*math.random() or 0.0) --let the value into [0,1] --force[3]/10.0 
    end
