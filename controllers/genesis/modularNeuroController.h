...
namespace stcontroller{
    ...
    class ModularNeuroController {
        ...
        public:
            ...
            // adaptive sensory feedback raised from physical communications
            std::vector<parameter > asf;
            // adaptive control input raised from neural communications
            std::vector<parameter > aci;
    };
