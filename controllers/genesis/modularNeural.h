...
#include "genesis-ann-library/COGReflex.h"
#include "genesis-ann-library/distributedForceReflex.h"
...
class ModularNeural : public ANN{
            ...
            //adaptive sensory feedback term in CPG
			float getCpgAsf(unsigned int ID, unsigned int index)const;
            //adaptive controil input term in CPG
			float getCpgAci(unsigned int ID, unsigned int index)const;
			//PCPG
            ...
            void setCPGModulationParameters(float gain, float threshold);
			...
			private:
				...
				std::vector<stcontroller::TouchReflex *> mTouchReflexs;// COG distribution reflexes
                ...
                stcontroller::COGReflex * cogReflex;// COG distribution reflexes
                DistributedForceReflex * dffbReflex;
				unsigned int n_CPGs;
				int tau,tau_l;
                ...
                float phaseResetThreshold; // synaptic CPG paramters for set the threshold of the phase reset mechanism
                float phaseModulationGain; // synaptic CPG paramters for set the gain of the phase modulation (sensory feedback, sf)
};
#endif
